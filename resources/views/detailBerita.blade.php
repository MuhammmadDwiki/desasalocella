            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('beranda') }}"
                        class="inline-flex items-center text-sm text-gray-700 hover:text-red-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('berita') }}"
                            class="ml-1 text-sm text-gray-700 hover:text-red-600 md:ml-2">Berita</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span
                            class="ml-1 text-sm text-gray-500 md:ml-2 truncate max-w-xs">{{ Str::limit($berita->judul_berita, 40) }}</span>
                    </div>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button onclick="shareTwitter()"
                                    class="p-2 bg-blue-100 text-blue-400 rounded-full hover:bg-blue-200 transition duration-200">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                ...
                                <button onclick="shareWhatsApp()"
                                    class="p-2 bg-green-100 text-green-600 rounded-full hover:bg-green-200 transition duration-200">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path
