...
@section('title', 'Visi & Misi - Desa Sallo Cela')
...
@section('content')
        ...
        <section class="px-5 py-8">
            ...
            <div class="bg-white rounded-lg p-6 shadow-md max-w-6xl mx-auto text-justify">
                ...
                <ol class="list-decimal pl-6 space-y-3 text-gray-700 leading-relaxed">
                    ...
                    <li>Peningkatan/pembangunan di seluruh wilayah Desa Sallo Cela, baik desa, pemukiman, dan peningkatan
                        sarana
        ...
        <section class="px-5 py-4 max-w-6xl mx-auto text-justify">
            ...
            <p class="text-gray-700 leading-relaxed mb-6">
                Desa Sallo Cela berdiri sejak puluhan tahun yang lalu sebagai salah satu pemukiman tertua di wilayah
                Kecamatan
            ...
            <p class="text-gray-700 leading-relaxed mb-6">
                ...
                Tahun demi tahun, Desa Sallo Cela semakin berkembang menjadi pusat kegiatan ekonomi kecil menengah di
                wilayah
                sekitarnya.
            ...
            <p class="text-gray-700 leading-relaxed mb-6">
                ...
                <br><br>
                Kini, Desa Sallo Cela terus bertransformasi menuju desa yang lebih maju dengan tetap mempertahankan kearifan
                lokalnya.
            ...
            <p class="text-gray-700 leading-relaxed mb-6">
                Desa Sallo Cela merupakan cerminan desa yang tumbuh dari semangat gotong royong dan kebersamaan
                masyarakatnya.
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mt-8">
                <div>
                    ...
                    <img src="{{ asset('images/petadesa.png') }}" alt="Peta Administrasi"
